...
# model - MAC/RMC backend for val testing
_C.mac = edict()
_C.mac.snapshot_path = osp.join(_C.root_dir, 'weights', 'epoch-87.pth.tar')
_C.mac.cuda_visible_devices = '1'
_C.mac.write_log_file = True
_C.mac.patch_topk = 16
_C.mac.max_corr = 256
_C.mac.edge_threshold = 0.99
_C.mac.dist_sigma_factor = 10.0
_C.mac.normal_sigma = 0.10
_C.mac.normal_k = 33
_C.mac.min_clique_size = 3
_C.mac.num_refinement_steps = 5
_C.mac.use_sog = True
_C.mac.use_normal_fog = True
_C.mac.fallback_to_lgr = True
_C.mac.max_hypotheses = 128
_C.mac.use_weighted_svd = False
_C.mac.use_weighted_scoring = False
